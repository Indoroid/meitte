...
| `2026-08-29-mmap-serialisation/` | Windows and Android mapping-release A/B | Source of the `--release-mmap` behavior and performance claims. Android throughput is directional because each variant has only two short runs. |
